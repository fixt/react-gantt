...
var GanttTimeline = (_temp2 = _class = function (_Component) {
  ...
  _createClass(GanttTimeline, [{
    ...
    value: function getSimpleTick() {
      ...
      var timelineDuration = (0, _moment2.default)(rightBound).diff((0, _moment2.default)(leftBound), 'seconds');

      var maxTicks = Math.ceil(timelineWidth / parseInt(style.minWidth, 10));

      return {
        width: this.durationToWidth(timelineDuration / (maxTicks - 2)),
        unit: 'year',
        count: maxTicks - 2
      };
    }
    ...
    value: function getTick(unit, timelineDuration) {
      ...
      var tickCount = Math.ceil(timelineDuration / this.units[unit]);
      var maxTicks = Math.ceil(timelineWidth / parseInt(style.minWidth, 10));
    ...
    value: function debugRender() {
      var _context5 = this.context,
          leftBound = _context5.leftBound,
          rightBound = _context5.rightBound,
          dateFormat = _context5.dateFormat,
          timelineWidth = _context5.timelineWidth;
    ...
    value: function defaultRender() {
      ...
      var simpleTickRendering = this.props.simpleTickRendering;

      var style = _lodash2.default.clone(this.props.style);
      var tick = simpleTickRendering ? this.getSimpleTick() : this.getTick();
  ...
  simpleTickRendering: _propTypes2.default.boolean
}, _class.defaultProps = {
  simpleTickRendering: true
}, _class.contextTypes = {
